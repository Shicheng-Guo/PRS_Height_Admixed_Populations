...
plot(data$EUR_ANC, data$RES, pch=16, cex=0.3, xlab="European Ancestry", ylab="Residual Height (SD)", bty="n" , xlim=c(0,1))
...
pdf("~/height_prediction/figs_for_paper/figs/Variance_model2_v2.pdf")
plot(data$EUR_ANC, data$RES, pch=16, cex=0.3, xlab="European Ancestry", ylab="Residual Height (SD)", bty="n" ,xlim=c(0,1))
...
pdf("~/height_prediction/figs_for_paper/figs/Variance_model3_v2.pdf")
plot(data$EUR_ANC, data$RES, col="lightgray", pch=16, cex=0.3, xlab="European Ancestry", ylab="Residual Height (SD)", bty="n" , xlim=c(0,1))
