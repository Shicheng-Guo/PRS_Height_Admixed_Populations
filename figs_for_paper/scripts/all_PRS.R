...
ggsave('~/height_prediction/loc_anc_analysis/figs/PRS1_2_WHI.pdf')

##add PRS3

PRS3_WHI<-readRDS('~/height_prediction/loc_anc_analysis/output/part_R2_WHI_unscaled.Rds')
dt_PRS3_WHI<-data.table(Part_R2=unlist(PRS3_WHI[1:101]), Alpha=seq(0,1, 0.01), Test="PRS3", Dataset="WHI_afr")
PRS3_JHS<-readRDS('~/height_prediction/loc_anc_analysis/output/part_R2_JHS_unscaled.Rds')
dt_PRS3_JHS<-data.table(Part_R2=unlist(PRS3_JHS[1:101]), Alpha=seq(0,1, 0.01), Test="PRS3", Dataset="JHS_afr")
PRS3_HRS<-readRDS('~/height_prediction/loc_anc_analysis/output/part_R2_HRS_unscaled.Rds')
