...
for(I in 22:1){
	...
	saveRDS(res, file=paste0("~/height_prediction/imputed/output/chr", I, "_prs.Rds"))
	res_all[[I]]<-res
	cat('Chr ', I, ' done\n')
}
...
optimize(max_alpha_v2, interval=c(0,1), maximum=T, tol = 0.0001) # 0.0454  0.04163149
optimize(max_alpha_conc_v2, interval=c(0,1), maximum=T, tol = 0.0001) # 0.1272932  0.02975213
