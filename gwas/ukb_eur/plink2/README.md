...
cd output/
cp /project/mathilab/bbita/gwas_admix/height/ukbiobank/50.assoc.tsv.gz .

zcat 50.assoc.tsv.gz > 50.assoc.tsv
...
awk -F":" '$1=$1' OFS="\t" 50.assoc.tsv|awk 'OFS="\t"{print $1,$4,$5,$6,$7, $8, $9}'| sed "1 s/^.*$/SNP\tAllele1\tAllele2\tBETA\tSE\tP\tN/" > tmp 
mv tmp 50.assoc.tsv
rm 50.assoc.tsv.gz
```
