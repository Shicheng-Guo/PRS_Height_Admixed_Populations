...
fwrite(JHS1,'~/height_prediction/gwas/JHS/plink2/output/betas_for_plink.txt', sep = "\t")
remove(JHS, JHS1)
#WHI
...
fwrite(WHI1,'~/height_prediction/gwas/WHI/plink2/output/betas_for_plink.txt', sep = "\t")
remove(WHI, WHI1)
#HRS_afr
...
fwrite(HRS_afr1,'~/height_prediction/gwas/HRS_afr/plink2/output/betas_for_plink.txt', sep = "\t")
...
fwrite(HRS_eur1,'~/height_prediction/gwas/HRS_eur/plink2/output/betas_for_plink.txt', sep = "\t")
...
fwrite(UKB_eur1,'~/height_prediction/gwas/ukb_eur/plink2/output/betas_for_plink.txt', sep = "\t")
...
fwrite(UKB_afr1,'~/height_prediction/gwas/ukb_afr/plink2/output/betas_for_plink.txt', sep = "\t")
