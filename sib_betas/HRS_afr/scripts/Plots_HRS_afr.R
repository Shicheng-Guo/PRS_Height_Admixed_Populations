...
txtStart(paste0("~/height_prediction/sib_betas/HRS_afr/plots_out.txt"))
#read in PGS scores
readRDS('~/height_prediction/sib_betas/HRS_afr/output/PGS_HRS_afr.Rds')-> PGS_HRS_afr
...
for(I in names(Nr_SNPs)){
        readRDS(paste0('~/height_prediction/sib_betas/HRS_afr/output/hei_', I, '.Rds'))-> smtg
...
for(I in 1:length(PGS2_HRS_afr)){
        ...
        png(filename=paste0('~/height_prediction/sib_betas/HRS_afr/figs/HRS_afr_ggpairs_', names(PGS2_HRS_afr)[I], '.png'))
        print(A)
...
saveRDS(PGS3_HRS_afr, file='~/height_prediction/sib_betas/HRS_afr/output/PGS3_HRS_afr.Rds')
saveRDS(results.HRS_afr, file='~/height_prediction/sib_betas/HRS_afr/output/results.HRS_afr.Rds')
...
for (I in names(PGS3_HRS_afr)){
       myp<-ggplot(B_HRS_afr[[I]][1:2,], aes(x=Med_Eur_Anc, y=R_sq)) +
        ...
        print(myp)
        ggsave(paste0('~/height_prediction/sib_betas/HRS_afr/figs/HRS_afr_error_bars_', I, '.png'))
}

saveRDS(B_HRS_afr, file="~/height_prediction/sib_betas/HRS_afr/output/B_HRS_afr.Rds")
txtStop()
