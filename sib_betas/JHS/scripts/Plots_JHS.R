...
for(I in names(Nr_SNPs)){
        readRDS(paste0('~/height_prediction/sib_betas/JHS/output/hei_', I, '.Rds'))-> smtg
...
saveRDS(A_table, file='~/height_prediction/sib_betas/JHS/output/Nr_SNPs_JHS.Rds')
...
for(I in 1:length(PGS2_JHS)){
        ...
        png(filename=paste0('~/height_prediction/sib_betas/JHS/figs/JHS_ggpairs_', names(PGS2_JHS)[I], '.png'))
        print(A)
...
#saveRDS(PGS3_JHS, file='/project/mathilab/bbita/sib_betas_admix/new_height/JHS/PGS3_JHS.Rds')

#saveRDS(results.JHS, file='/project/mathilab/bbita/sib_betas_admix/new_height/JHS/results.JHS.Rds')
...
saveRDS(PGS3_JHS, file='~/height_prediction/sib_betas/JHS/output/PGS3_JHS.Rds')
saveRDS(results.JHS, file='~/height_prediction/sib_betas/JHS/output/results.JHS.Rds')
...
for (I in names(PGS3_JHS)){
        ...
        print(myp)
        ggsave(paste0('~/height_prediction/sib_betas/JHS/figs/error_bars_', I, '.png'))
}
