...
Rscript --vanilla $currentdir/LD_prunning.R --chromosome $i --method phys --windowsize $w --pvalue $j
echo $w
echo 'done'
done
...
Rscript --vanilla $currentdir/LD_prunning.R --chromosome $i --method genet --windowsize $w --pvalue $j
echo $w
echo 'done'
done
echo $j
...
Rscript --vanilla LD_prunning.R --chromosome $i --method LD --windowsize $w --pvalue 0.01 --r2 0.5
echo $w
echo 'done'
done
echo $i
...
Rscript --vanilla LD_prunning.R --chromosome $i --method LD_block --windowsize 0 --pvalue 0
echo $j
echo 'done'
done
