...
with(combo_prs, cor.test(BETA,POP1)) # 0.4753081
with(combo_prs, cor.test(BETA,POP2)) # 0.6675789
with(combo_prs, cor.test(BETA,ALL)) # 0.7782334


with(combo_local, cor.test(BETA,POP1)) # 0.3835631
with(combo_local, cor.test(BETA,POP2)) #0.6106556
with(combo_local, cor.test(BETA,ALL)) #0.7052459
...
pdf('~/height_prediction/runSmartpCA-master/UKB_AFR/figs/manhattan_plink_UKB.pdf')
...
pdf('~/height_prediction/runSmartpCA-master/UKB_AFR/figs/manhattan_LA_UKB.pdf')
manhattan(df2, genomewideline=F, suggestiveline=F)
dev.off()
...
pdf('~/height_prediction/runSmartpCA-master/UKB_AFR/figs/qqplot_LA_UKB.pdf')
