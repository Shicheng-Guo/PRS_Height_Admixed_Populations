...
a1<-lapply(a , function(X) paste0('~/height_prediction/ldpred/output/UKB_AFR.score_P+T_r0.20', X,'.txt'))
...
saveRDS(B_UKB_afr, file="~/height_prediction/ldpred/output/B_UKB_afr_all.Rds")
