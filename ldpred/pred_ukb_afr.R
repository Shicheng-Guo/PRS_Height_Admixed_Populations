...
lapply(a , function(X) fread(paste0('~/height_prediction/ldpred/output/UKB_AFR.score_LDpred', X,'.txt')))-> PGS_UKB_afr
names(PGS_UKB_afr)<-a
...
saveRDS(PGS2_UKB_afr, file='~/height_prediction/ldpred/output/PGS2_UKB_afr.Rds')
