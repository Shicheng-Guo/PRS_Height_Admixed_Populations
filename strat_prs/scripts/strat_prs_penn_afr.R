...
w_map<-args[2]
PRS<-vector('list', 22)
afr<-fread('/project/mathilab/bbita/gwas_admix/new_height/pennBB_afr_betas_100000_0.0005.txt')
...
hei<-lapply(1:22, function(chr) readRDS('/project/mathilab/bbita/gwas_admix//new_height/pennBB_afr/hei_phys_100000_0.0005_v2.Rds')[[chr]])
...
setDT(readRDS('/project/pmbb_mathi_lab/phenotypes/cov_afr_nophi_170815.RDS'))-> Pheno_pennBB_afr
fread('/project/mathilab/bbita/gwas_admix/height/pennBB/afr/Final_AFR_Height_Weight_BMI.txt')-> Pheno2_pennBB_afr
...
#add ancestry
anc_pennBB_afr<-cbind(fread('/project/mathilab/bbita/gwas_admix/height/pennBB/afr/PRUNED.2.Q'), fread('/project/mathilab/bbita/gwas_admix/height/pennBB/afr/PRUNED.fam')[,V2])
