...
w_map<-args[2]
PRS<-vector('list', 22)
jhs<-do.call(rbind, readRDS(paste0('~/height_prediction/', args[3],'/JHS/output/hei_phys_100000_0.0005_v2.Rds')))[,.(CHR,POS,MarkerName,REF,ALT,Allele1,Allele2,b,p)]
if(args[2]=='AA'){
...
saveRDS(jhs, file=paste0("~/height_prediction/strat_prs/output/rec_quant_JHS_",args[3], '_',rate.dist, "_", w_map, "_v2.Rds")) #store results
#Make a list
