...
w_map<-args[2]
PRS<-vector('list', 22)
jhs<-fread('/project/mathilab/bbita/gwas_admix/new_height/jhs_betas_100000_0.0005.txt')
...
hei<-lapply(1:22, function(chr) readRDS('/project/mathilab/bbita/gwas_admix/new_height/JHS/hei_phys_100000_0.0005_v2.Rds')[[chr]])
