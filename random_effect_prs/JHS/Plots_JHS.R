...
#read in PGS scores
readRDS('~/height_prediction/random_effect_prs/output/PGS_JHS.Rds')-> PGS_JHS
...
saveRDS(A_table, file='~/height_prediction/random_effect_prs/output/Nr_SNPs_JHS.Rds')
...
for(I in 1:length(PGS2_JHS)){
        ...
        png(filename=paste0('~/height_prediction/random_effect_prs/figs/JHS_ggpairs_', names(PGS2_JHS)[I], '.png'))
        print(A)
...
saveRDS(PGS3_JHS, file='~/height_prediction/random_effect_prs/output/PGS3_JHS.Rds')
saveRDS(results.JHS, file='~/height_prediction/random_effect_prs/output/results.JHS.Rds')
...
saveRDS(B_JHS, file="~/height_prediction/random_effect_prs/output/B_JHS.Rds")
