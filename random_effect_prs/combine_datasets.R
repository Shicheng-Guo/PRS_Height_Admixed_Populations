...
##
readRDS('~/height_prediction/random_effect_prs/output/results.WHI.Rds')-> results.WHI
readRDS('~/height_prediction/random_effect_prs/output/results.JHS.Rds')-> results.JHS
readRDS('~/height_prediction/random_effect_prs/output/results.UKB_afr.Rds')-> results.UKB_afr
readRDS('~/height_prediction/random_effect_prs/output/results.HRS_eur.Rds')-> results.HRS_eur
readRDS('~/height_prediction/random_effect_prs/output/results.HRS_afr.Rds')-> results.HRS_afr
readRDS('~/height_prediction/random_effect_prs/output/B_WHI.Rds')->B_WHI
readRDS('~/height_prediction/random_effect_prs/output/B_JHS.Rds')->B_JHS
readRDS('~/height_prediction/random_effect_prs/output/B_UKB_afr.Rds')-> B_UKB_afr
readRDS('~/height_prediction/random_effect_prs/output/B_HRS_eur.Rds')-> B_HRS_eur
readRDS('~/height_prediction/random_effect_prs/output/B_HRS_afr.Rds')-> B_HRS_afr
readRDS('~/height_prediction/random_effect_prs/output/PGS3_UKB_afr.Rds')-> PGS3_UKB_afr
readRDS('~/height_prediction/random_effect_prs/output/PGS3_WHI.Rds')-> PGS3_WHI
readRDS('~/height_prediction/random_effect_prs/output/PGS3_JHS.Rds')-> PGS3_JHS
readRDS('~/height_prediction/random_effect_prs/output/PGS3_HRS_eur.Rds')-> PGS3_HRS_eur
readRDS('~/height_prediction/random_effect_prs/output/PGS3_HRS_afr.Rds')-> PGS3_HRS_afr
...
#	}
	...
	print(my_plot)
	ggsave(paste0('~/height_prediction/random_effect_prs/figs/error_bars_all_v2_', I, '.png'))
}
#
...
#	}
	...
	theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.title.y = element_text(size = 15), axis.title.x=element_text(size=15),axis.text.x=element_text(size=12), axis.text.y=element_text(size=12), legend.key=element_blank(), legend.background=element_blank(),legend.title=element_blank(), legend.text=element_text(size=12))
	print(my_plot2)
	ggsave(paste0('~/height_prediction/random_effect_prs/figs/error_bars_all_v3_', I, '.png'))
}
...
fwrite(a, file="/~/height_prediction/random_effect_prs/figs/SM_Table1.txt", sep=",")
...
#        }
	...
	my_plot2<-ggplot(ALL2b[[I]], aes(x=Med_Eur_Anc, y=R_sq)) +
		...
		theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.title.y = element_text(size = 15), axis.title.x=element_text(size=15),axis.text.x=element_text(size=12), axis.text.y=element_text(size=12), legend.key=element_blank(), legend.background=element_blank(),legend.title=element_blank(), legend.text=element_text(size=12))
        print(my_plot2)
        ggsave(paste0('~/height_prediction/random_effect_prs/figs/error_bars_all_v3b_', I, '.png'))
}
...
for(I in names(B_JHS)){
	...
	scale_color_manual(values=c(brewer.pal(4, 'Set1'),"#101010")) + 
  	...
  	theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.title.y = element_text(size = 15), axis.title.x=element_text(size=15),axis.text.x=element_text(size=12), axis.text.y=element_text(size=12), legend.key=element_blank(), legend.background=element_blank(), legend.title=element_blank(), legend.text=element_text(size=12)) 
	print(my_plot)
        ggsave(paste0('~/height_prediction/random_effect_prs/figs/error_bars_all_v4_', I, '.png'))
}
#
...
fwrite(combo2, file="~/height_prediction/random_effect_prs/output/WHI_JHS_UKB_HRS_summ.txt", sep="\t")
