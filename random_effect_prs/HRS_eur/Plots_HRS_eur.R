...
#read in PGS scores
readRDS('~/height_prediction/random_effect_prs/output/PGS_HRS_eur.Rds')-> PGS_HRS_eur
...
saveRDS(A_table, file='~/height_prediction/random_effect_prs/output/Nr_SNPs_HRS.Rds')
...
for(I in 1:length(PGS2_HRS_eur)){
        ...
        png(filename=paste0('~/height_prediction/random_effect_prs/figs/HRS_eur_ggpairs_', names(PGS2_HRS_eur)[I], '.png'))
        print(A)
...
saveRDS(results.HRS_eur, file='~/height_prediction/random_effect_prs/output/results.HRS_eur.Rds')
saveRDS(PGS3_HRS_eur, file='~/height_prediction/random_effect_prs/output/PGS3_HRS_eur.Rds')
...
saveRDS(B_HRS_eur, file="~/height_prediction/random_effect_prs/output/B_HRS_eur.Rds")
...
ggsave('~/height_prediction/random_effect_prs/figs/reg_rsq_eur_anc_LD.png')
#
...
ggsave('~/height_prediction/random_effect_prs/figs/ashg_like.png')
