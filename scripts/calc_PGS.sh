...
Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} ${dtset2} LD_${i}_0.01_0.5
echo $i
echo 'done'
done


bsub -M 10240 Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} dtset2 LD_block_0_0_AFR

bsub -M 10240 Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} dtset2 LD_block_0_0_EUR
...
Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} ${dtset2} phys_${i}_${j}
echo $j
echo 'done'
done
echo $i
...
Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} ${dtset2} genet_${i}_${j}
echo $j
echo 'done'
done
echo $i
