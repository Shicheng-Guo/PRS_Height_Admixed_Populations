...
echo 'Window size is '
echo $i
bsub -M 100000 -o ~/height_prediction/logs/log_${dtset1}_${dtset2}_${i}_${j}_prs -e ~/height_prediction/logs/log_${dtset1}_${dtset2}_${i}_${j}_prs  Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} ${dtset2} LD_${i}_0.01_0.5
echo $i
echo 'done'
done

bsub -M 95240 -o ~/height_prediction/logs/log_${dtset1}_${dtset2}_LD_block_AFR_prs -e ~/height_prediction/logs/log_${dtset1}_${dtset2}_LD_block_AFR_prs Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} ${dtset2} LD_block_0_0_AFR
...
do
echo $j
bsub -M 95240 -o ~/height_prediction/logs/log_${i}_${j}_prs -e ~/height_prediction/logs/log_${i}_${j}_prs  Rscript --vanilla ~/height_prediction/scripts/run_PRS.R ${dtset1} ${dtset2} genet_${i}_${j}
echo $j
echo 'done'
done
echo $i
