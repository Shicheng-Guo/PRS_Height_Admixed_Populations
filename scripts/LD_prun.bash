...
bsub -M 30240  ~/height_prediction/scripts/LD_prunning.R --chromosome $i --method LD_block --windowsize 0 --pvalue 0 --dataset1 $dtset1 --dataset2 $dtset2
echo $j
echo 'done'
done
...
bsub -M 20240 Rscript --vanilla ~/height_prediction/scripts/LD_prunning.R --chromosome $i --method LD --windowsize $w --pvalue 0.01 --r2 0.5 --dataset1 $dtset1 --dataset2 $dtset2
echo $w
echo 'done'
done
echo $i
...
bsub -M 30240 Rscript --vanilla ~/height_prediction/scripts/LD_prunning.R --chromosome $i --method phys --windowsize $w --pvalue $j --dataset1 $dtset1 --dataset2 $dtset2
echo $w
echo 'done'
done
...
bsub -M 30240 Rscript --vanilla ~/height_prediction/scripts/LD_prunning.R --chromosome $i --method genet --windowsize $w --pvalue $j --dataset1 $dtset1 --dataset2 $dtset2
echo $w
echo 'done'
done
echo $j
