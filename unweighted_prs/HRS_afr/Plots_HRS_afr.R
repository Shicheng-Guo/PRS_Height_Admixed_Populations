...
saveRDS(A_table, file='~/height_prediction/unweighted_prs/output/Nr_SNPs_HRS_afr.Rds')
...
for(I in 1:length(PGS2_HRS_afr)){
        ...
        png(filename=paste0('~/height_prediction/unweighted_prs/figs/HRS_afr_ggpairs_', names(PGS2_HRS_afr)[I], '.png'))
        print(A)
...
saveRDS(PGS3_HRS_afr, file='~/height_prediction/unweighted_prs/output/PGS3_HRS_afr.Rds')
saveRDS(results.HRS_afr, file='~/height_prediction/unweighted_prs/output/results.HRS_afr.Rds')
...
for (I in names(PGS3_HRS_afr)){
       myp<-ggplot(B_HRS_afr[[I]][1:2,], aes(x=Med_Eur_Anc, y=R_sq)) +
        ...
        print(myp)
        ggsave(paste0('~/height_prediction/unweighted_prs/figs/HRS_afr_error_bars_', I, '.png'))
}
