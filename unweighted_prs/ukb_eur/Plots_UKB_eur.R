...
for(I in 1:length(PGS2_UKB_eur)){
        ...
        png(filename=paste0('~/height_prediction/unweighted_prs/figs/UKB_eur_ggpairs_', names(PGS2_UKB_eur)[I], '.png'))
        print(A)
...
saveRDS(PGS3_UKB_eur, file='~/height_prediction/unweighted_prs/output/PGS3_UKB_eur.Rds')
saveRDS(results.UKB_eur, file='~/height_prediction/unweighted_prs/output/results.UKB_eur.Rds')
