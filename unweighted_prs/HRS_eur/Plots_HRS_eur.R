...
saveRDS(A_table, file='~/height_prediction/unweighted_prs/output/Nr_SNPs_HRS.Rds')
...
for(I in 1:length(PGS2_HRS_eur)){
        ...
        png(filename=paste0('~/height_prediction/unweighted_prs/figs/HRS_eur_ggpairs_', names(PGS2_HRS_eur)[I], '.png'))
        print(A)
...
saveRDS(results.HRS_eur, file='~/height_prediction/unweighted_prs/output/results.HRS_eur.Rds')
saveRDS(PGS3_HRS_eur, file='~/height_prediction/unweighted_prs/output/PGS3_HRS_eur.Rds')
...
saveRDS(B_HRS_eur, file="~/height_prediction/unweighted_prs/output/B_HRS_eur.Rds")
...
ggsave('~/height_prediction/unweighted_prs/figs/reg_rsq_eur_anc_LD.png')
#
