...
select(hei, -c(i.MarkerName, QUAL, FILTER,INFO, FORMAT, N, SE))-> hei
...
saveRDS(plink_prun2, file=paste0('~/height_prediction/loc_anc_analysis/output/plink_prun2_chr', chr, '.Rds'))
