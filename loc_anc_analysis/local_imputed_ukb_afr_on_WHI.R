...
final_JHS<-final_JHS[-which(!complete.cases(final_JHS$HEIGHT))]
...
#WHI
partial.R2(lm(HEIGHTX~AGE+AGE2+EUR_ANC, data=final2), lm(HEIGHTX~AGE+AGE2+EUR_ANC+PRS_EUR, data=final2))*100 #3.578924
...
partial.R2(lm(HEIGHTX~AGE+AGE2+EUR_ANC+PRS_EUR, data=final2),lm(HEIGHTX~AGE+AGE2+EUR_ANC+PRS_EUR+PRS_eur_afr_plink, data=final2))*100 #0.3077749
partial.R2(lm(HEIGHTX~AGE+AGE2+EUR_ANC+PRS_EUR, data=final2),lm(HEIGHTX~AGE+AGE2+EUR_ANC+PRS_EUR+PRS_plink, data=final2))*100 #0.2631669
#
#JHS
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC, data=final2_JHS), lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR, data=final2_JHS))*100 #3.825324
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC, data=final2_JHS), lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_plink, data=final2_JHS))*100 #1.484073
...
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC, data=final2_JHS), lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_eur_afr_plink, data=final2_JHS))*100 # #1.966994
#here we see that there's potential in including AFR betas::
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR, data=final2_JHS),lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR+PRS_eur_afr_plink, data=final2_JHS))*100 #0.1824423
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR, data=final2_JHS),lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR+PRS_plink, data=final2_JHS))*100 #0.2590213
#HRS
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC, data=final2_HRS), lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR, data=final2_HRS))*100 #3.103462
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC, data=final2_HRS), lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_plink, data=final2_HRS))*100 #0.7241404
...
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC, data=final2_HRS), lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_eur_afr_plink, data=final2_HRS))*100 # #1.24982
#here we see that there's potential in including AFR betas::
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR, data=final2_HRS),lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR+PRS_eur_afr_plink, data=final2_HRS))*100 # 0.1121853
partial.R2(lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR, data=final2_HRS),lm(HEIGHTX~SEX+AGE+AGE2+EUR_ANC+PRS_EUR+PRS_plink, data=final2_HRS))*100 #0.09691087
###################
##################a
a_vec<-seq(0,1,0.01)
##################
