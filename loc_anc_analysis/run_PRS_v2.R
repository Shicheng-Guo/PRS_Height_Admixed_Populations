...
#7. This script runs each chromosome separely. The script (run_partial_r2.r) combined these outputs and evaluates prediction power
###########################################
...
LA_PRS<- function(X=geno2, X2=10, Y=anc2, alpha=as.numeric(args[3])){
